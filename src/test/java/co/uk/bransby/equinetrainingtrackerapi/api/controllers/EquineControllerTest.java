...
class EquineControllerTest {
    ...
    void setUp() {
        ...
        equineList.add(new Equine(1L, "First Horse", new Yard(), new EquineStatus(), new Programme(), new HashSet<Skill>()));
        equineList.add(new Equine(2L, "Second Horse", new Yard(), new EquineStatus(), new Programme(), new HashSet<Skill>()));
        equineList.add(new Equine(3L, "Third Horse", new Yard(), new EquineStatus(), new Programme(), new HashSet<Skill>()));
        equineList.add(new Equine(4L, "Fourth Horse", new Yard(), new EquineStatus(), new Programme(), new HashSet<Skill>()));
        equineList.add(new Equine(5L, "Fifth Horse", new Yard(), new EquineStatus(), new Programme(), new HashSet<Skill>()));
    }
    ...
    void createEquine() throws Exception {
        ...
        Equine newEquine = new Equine(6L, "Sixth Horse", new Yard(), new EquineStatus(), new Programme(), new HashSet<Skill>());
    ...
    void updateEquine() throws Exception {
        Equine EquineToUpdate = new Equine(1L, "Updated Horse", new Yard(), new EquineStatus(), new Programme(), new HashSet<Skill>());
    ...
    void returnsNotFoundIfEquineAbsentWhenUpdated() throws Exception {
        Equine invalidEquine = new Equine(9L, "Invalid Horse", new Yard(), new EquineStatus(), new Programme(), new HashSet<Skill>());
