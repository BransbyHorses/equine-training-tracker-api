...
public class ProgrammeController {
    ...
    public ProgrammeController(ProgrammeService programmeService, ModelMapper modelMapper) {
    ...
    @PutMapping("{id}")
    public ResponseEntity<ProgrammeDto> updateProgramme(@PathVariable Long id, @RequestBody ProgrammeDto updatedProgrammeValues) {
        HttpHeaders resHeaders = new HttpHeaders();
        try {
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<ProgrammeDto> deleteProgramme(@PathVariable Long id) {
        HttpHeaders resHeaders = new HttpHeaders();
        return programmeService.getProgramme(id)
                .map(programme -> {
